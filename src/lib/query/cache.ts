...
export function clearProjectScopedQueryCache(queryClient: QueryClient): void {
  ...
  queryClient.removeQueries({ queryKey: queryKeys.projectSecretSyncs.all })
  ...
  queryClient.removeQueries({ queryKey: queryKeys.projectEnvironments.all })
  queryClient.removeQueries({ queryKey: queryKeys.projectSettings.all })
